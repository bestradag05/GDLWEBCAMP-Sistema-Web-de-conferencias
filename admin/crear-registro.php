        ...
        <div class="box-body">
            ...
            <form role="form" name="guardar-registro" id="guardar-registro" method="POST" action="modelo-registrado.php">
                                  ...
                                  <div class="tabla-precio text-center">
                                      ...
                                      <ul>
                                       ...
                                       <div class="orden">
                                          ...
                                          <input type="number" min="0" class="form-control" id="pase_completo" size="3" name="boletos[completo][cantidad]" placeholder="0" />
                                  ...
                                  <div class="tabla-precio text-center ">
                                      ...
                                      <ul>
                                       ...
                                       <div class="orden">
                                          ...
                                          <input type="number" min="0" class="form-control" id="pase_dosdias" size="3" name="boletos[2dias][cantidad]" placeholder="0" />
              ...
              <div class="box-footer">
                  ...
                  <button type="submit" id="btnRegistro" class="btn btn-primary" >Añadir</button>
              </div>
            </form>
