...
foreach ($numeroboletos as $key => $value)// se obtiene la llave y el valor del arreglo
{
...
foreach ($pedidoExtra as $key => $value)// se obtiene la llave y el valor del arreglo
{
if((int)$value['cantidad']> 0)
{
    if($key == 'camisas')
